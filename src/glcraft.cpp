...
/* Sources for understanding and code chunks:
http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_1		CreatingChunks and SuperChunks
http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_2		Removing invisible faces
http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_3		Texturing
http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_4		First person camera using glm
http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_5		Rendering only front facing triangles.
http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_6		Adding/Removing Voxels

Shadowmapping, shaders, noise based procedural generation, and some other efficiency/features from:
https://gitorious.org/wikibooks-opengl/modern-tutorials/source/90bf72991caf34ea6cdbed044a9616b7bbdf2d0f:glescraft-accum

https://gitorious.org/wikibooks-opengl/modern-tutorials/source/90bf72991caf34ea6cdbed044a9616b7bbdf2d0f:glescraft-shadowmapping
*/
...
#include <GL/glew.h>
#include <GL/glut.h>
/* Using GLM for our transformation matrices, this comes especially in handy for the camera. */
...
//Defining the Chunk was done by following http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_1
//Removing invisible faces is covered in http://en.wikibooks.org/wiki/OpenGL_Programming/Glescraft_2
struct chunk 
{
...
int main(int argc, char* argv[]) {
	...
	printf("Press F4 to change which faces are being culled(Back/Front)\n");
	printf("Press F5 to stop warping the mouse to the centre.\n");
